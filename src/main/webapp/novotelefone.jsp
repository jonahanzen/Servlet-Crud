						...
						<form action="telefone" method="post">
							...
							<div class="form-row">
								<div class="form-group col">
									...
									<input type="number" required class="form-control" name="ddd" id="ddd" min="0"
										max="99" placeholder="DDD">
								</div>
								<div class="form-group col">
									<label for="numero">Número</label>
									<input type="text" required class="form-control" id="numero" name="numero"
										minlength="9" maxlength="9" placeholder="Insira o seu Número">
									<br>
									<br>
									<input type="submit" id="submit" name="submit" class="btn btn-primary form-control"
										value="Registrar">
								</div>
								<div class="form-group col">
									<label for="tipo">Tipo de telefone</label> <select id="tipo" class="form-control"
										name="tipoTelefone">
